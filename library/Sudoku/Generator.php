...
//@TODO: generator - zwraca fałszywe wyniki
class SG_Encryption {
...
class SG_SudokuGenerator {
    ...
    private function shuffle() {
        ...
        for($j = 0; $j < $randomNumber; $j++) {
            ...
            for($i = 0; $i < $this->size; $i++) {
                ...
                // zamiana wierszy
                list($this->table[$transform[1]], $this->table[$transform[0]]) = array($this->table[$transform[0]], $this->table[$transform[1]]);
    ...
    public function getData() {
        $out = array(
          'table' => json_encode($this->getTable()),
          'mask' => json_encode($this->getMask()),
          'data' => json_encode($this->getEncodedData()),
        );
        $out['sig'] = md5($out['table'] . $out['mask']);
        $out['sig_table'] = md5($out['table']);
